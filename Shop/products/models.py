...
class Cart(models.Model):
    ...
    cart_totalprice = models.FloatField(default=0,blank=True,null=True)
    cart_totalquantity = models.IntegerField(default=0,blank=True,null=True)
